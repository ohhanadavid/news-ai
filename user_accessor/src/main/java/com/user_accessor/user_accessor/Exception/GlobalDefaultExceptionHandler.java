...
class GlobalDefaultExceptionHandler {
    ...
    public ResponseEntity<String> defaultErrorHandler(HttpServletRequest req, Exception e) throws Exception {
        ...
        if (e instanceof DuplicateKeyException || e instanceof ItemFoundException) {
            return new ResponseEntity<>(anErrorResponse("Duplicate Id"), HttpStatus.CONFLICT);
        } else if (e instanceof EmptyResultDataAccessException |e instanceof ItemNotFoundException) {
            return new ResponseEntity<>(anErrorResponse("Not Found"), HttpStatus.NOT_FOUND);
            // we raise runtime exceptions for business issues.
        } else if (e instanceof MissingServletRequestParameterException ||e instanceof IllegalArgumentException) {
